...
Ce fichier contient les éléments de correction attendus pour les exercices du jour 03.  
...
Adapter les détails de cette correction au contenu exact de `exercises.md` lorsque les exercices définitifs du jour 03 sont disponibles.  
